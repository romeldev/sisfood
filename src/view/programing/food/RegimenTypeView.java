...
import view.assets.RegimenTypeTM;
 ...
 * @author HP_RYZEN
 */
public class RegimenTypeView extends javax.swing.JFrame {

    /**
     * Creates new form RegimenTypeView
     */
    RegimenTypeBO regimenTypeBO = new RegimenTypeBO();
    CompanyBO companyBO = new CompanyBO();
    ArrayList<RegimenType> list = new ArrayList<>();
    RegimenType item = new RegimenType();
    RegimenTypeTM tblModel = new RegimenTypeTM();
    
    public RegimenTypeView() {
        initComponents();
        txtId.setEnabled(false);
        this.setLocationRelativeTo(null);
        fillCompanies(cbxEmpresa);
...
//        fillList();
    ...
    public void fillCompanies(JComboBox cbx){
        cbx.removeAllItems();
        ArrayList<Company> companies = companyBO.list();
    ...
    {
        Company c = (Company) cbxEmpresa.getSelectedItem();
        list = regimenTypeBO.listByCompanyId(c.getId());
    ...
    private void initComponents() {
        ...
        cbxEmpresa.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "uno", "dos", "tren" }));
        cbxEmpresa.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                cbxEmpresaItemStateChanged(evt);
            }
        });
        cbxEmpresa.addHierarchyListener(new java.awt.event.HierarchyListener() {
            public void hierarchyChanged(java.awt.event.HierarchyEvent evt) {
                cbxEmpresaHierarchyChanged(evt);
            }
        });
        ...
        cbxEmpresa.addInputMethodListener(new java.awt.event.InputMethodListener() {
            public void caretPositionChanged(java.awt.event.InputMethodEvent evt) {
                cbxEmpresaCaretPositionChanged(evt);
            }
            public void inputMethodTextChanged(java.awt.event.InputMethodEvent evt) {
                cbxEmpresaInputMethodTextChanged(evt);
            }
        });
        ...
        cbxEmpresa.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                cbxEmpresaPropertyChange(evt);
            }
        });
        cbxEmpresa.addVetoableChangeListener(new java.beans.VetoableChangeListener() {
            public void vetoableChange(java.beans.PropertyChangeEvent evt)throws java.beans.PropertyVetoException {
                cbxEmpresaVetoableChange(evt);
            }
        });
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(cbxEmpresa, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        item.setCompany((Company)cbxEmpresa.getSelectedItem());
        item.setId(id);
        ...
        if( id == 0){
            success = regimenTypeBO.create( item );
            message += " guardado!";
        }else {
            success = regimenTypeBO.update( item );
            message += " actualizado!";
        }
        if( success ){
            fillList();
    ...
    private void cbxEmpresaPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_cbxEmpresaPropertyChange
        // TODO add your handling code here:
        
    }//GEN-LAST:event_cbxEmpresaPropertyChange
    ...
    private void cbxEmpresaCaretPositionChanged(java.awt.event.InputMethodEvent evt) {//GEN-FIRST:event_cbxEmpresaCaretPositionChanged
        // TODO add your handling code here:
        
    }//GEN-LAST:event_cbxEmpresaCaretPositionChanged

    private void cbxEmpresaHierarchyChanged(java.awt.event.HierarchyEvent evt) {//GEN-FIRST:event_cbxEmpresaHierarchyChanged
        // TODO add your handling code here:
        
    }//GEN-LAST:event_cbxEmpresaHierarchyChanged

    private void cbxEmpresaInputMethodTextChanged(java.awt.event.InputMethodEvent evt) {//GEN-FIRST:event_cbxEmpresaInputMethodTextChanged
        // TODO add your handling code here:
        
    }//GEN-LAST:event_cbxEmpresaInputMethodTextChanged

    private void cbxEmpresaVetoableChange(java.beans.PropertyChangeEvent evt)throws java.beans.PropertyVetoException {//GEN-FIRST:event_cbxEmpresaVetoableChange
        // TODO add your handling code here:
        
    }//GEN-LAST:event_cbxEmpresaVetoableChange
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegimenTypeView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new RegimenTypeView().setVisible(true);
//            }
//        });

        RegimenTypeView app = new RegimenTypeView();
        app.setVisible(true);
    }
