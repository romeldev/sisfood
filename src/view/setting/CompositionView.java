...
import view.assets.CompositionTM;
 ...
 * @author HP_RYZEN
 */
public class CompositionView extends javax.swing.JFrame {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if( id == 0){
            success = composicionBO.create( item );
            message += " guardado!";
        }else {
            success = composicionBO.update( item );
            message += " actualizado!";
        }
        if( success ){
            fillList();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CompositionView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CompositionView().setVisible(true);
            }
        });
    }
