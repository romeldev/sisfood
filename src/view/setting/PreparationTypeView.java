...
import view.assets.PreparationTypeTM;
 ...
 * @author HP_RYZEN
 */
public class PreparationTypeView extends javax.swing.JFrame {

    /**
     * Creates new form PreparationTypeView
     */
    ...
    PreparationTypeTM tblModel = new PreparationTypeTM();
    
    public PreparationTypeView() {
        initComponents();
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if( id == 0){
            success = preparationTypeBO.create( item );
            message += " guardado!";
        }else {
            success = preparationTypeBO.update( item );
            message += " actualizado!";
        }
        if( success ){
            fillList();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PreparationTypeView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PreparationTypeView().setVisible(true);
            }
        });
    }
